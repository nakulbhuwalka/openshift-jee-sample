 ...
 * 
 */
@WebServiceClient(name = "CustomerService", targetNamespace = "http://www.example.org/CustomerService/", wsdlLocation = "file:/C:/stsws/SampleApp/src/main/resources/CustomerService.wsdl")
    ...
    extends Service
{
    ...
    private final static QName CUSTOMERSERVICE_QNAME = new QName("http://www.example.org/CustomerService/", "CustomerService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/C:/stsws/SampleApp/src/main/resources/CustomerService.wsdl");
    ...
    public CustomerService getCustomerServiceSOAP() {
        return super.getPort(new QName("http://www.example.org/CustomerService/", "CustomerServiceSOAP"), CustomerService.class);
    }
    ...
    public CustomerService getCustomerServiceSOAP(WebServiceFeature... features) {
        return super.getPort(new QName("http://www.example.org/CustomerService/", "CustomerServiceSOAP"), CustomerService.class, features);
    }
